...
::: {.callout-important}
**TO DO**
Add what cache directory we are using
:::
...
As our first exercise, we will execute the `hello` workflow directly from `nextflow-io` [GitHub](https://github.com/nextflow-io/hello) repository. Start by creating a directory `lesson1.1` and change into it move into it. 
