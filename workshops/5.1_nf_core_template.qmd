...
::: {.callout-important}
**TO DO**
Module loading required? / Version?
:::
...
::: {.callout-important}
If nf-core is already downloaded, then don't need this step.
...
### **5.2.1 Module file and process structure**
...
### **5.2.2 Importing modules into a Nextflow script**
...
### **5.4.2 Analysis workflow script `workflows/customrnaseq.nf`**
...
### **5.4.3 Samplesheet `assets/samplesheet.csv`**
...
Also copy the following test data to your folder. 

::: {.callout-important}
**TO DO**

Copy test data to your directory

**TRANSCRIPTOME FILE**
:::

```default
cp -r <PATH TO TEST DATA> .
```
