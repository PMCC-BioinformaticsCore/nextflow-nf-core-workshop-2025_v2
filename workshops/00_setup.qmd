...
- Test your remote connection to the HPC and create a directory `/scratch/users/<your-username>/nfWorkshop` in your scratch space. This will be our working directory

::: {.callout-important}
**TO DO**

Change to scratch dir path
:::
